...
public class TaskController extends BaseController
{
     ...
     * 查询任务列表
     */
    @PreAuthorize("@ss.hasPermi('tps:task:list')")
    @GetMapping("/list")
     ...
     * 导出任务列表
     */
    @PreAuthorize("@ss.hasPermi('tps:task:export')")
     ...
     * 获取任务详细信息
     */
    @PreAuthorize("@ss.hasPermi('tps:task:query')")
     ...
     * 新增任务
     */
    @PreAuthorize("@ss.hasPermi('tps:task:add')")
     ...
     * 修改任务
     */
    @PreAuthorize("@ss.hasPermi('tps:task:edit')")
     ...
     * 删除任务
     */
    @PreAuthorize("@ss.hasPermi('tps:task:remove')")
